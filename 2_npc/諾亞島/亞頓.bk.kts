...
val question1 = NPCQuestion(*Utils.getMessage(npcIcon,
        ...
        .addPlayerOptions(
                PlayerOption("&7[&a對話選項&7] &f這裡是?").setResult { player -> player.sendMessage(*Utils.getMessage(npcIcon,
                        "${npcName}:",
                        "§7這裡是傭兵公會在諾亞鎮的分會",
                        "§7你可以在這裡接受各種委託",
                ))},
...
ScriptedQuests.getInstance().conversationManager.pushNPCQuestion(52,question1)