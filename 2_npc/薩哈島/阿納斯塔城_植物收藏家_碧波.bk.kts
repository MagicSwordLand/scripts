...
val npcIcon = IconFonts.getNPC(252);
val npcName = "§b● §e碧波§r"
val side01 = "side_gold_14"
...
val question1 = NPCQuestion(*Utils.getMessage(npcIcon,
        ...
        .addPlayerOptions(
                ...
                // 任務
                PlayerOption("§7[§b金牌支線§7] §f精靈樹的誕生 &8(階級需求:黃金)")
...
ScriptedQuests.getInstance().questManager.getQuest(side01).ifPresent {
    question1.addPlayerOptions(it.getStartOption("§7[§b金牌支線§7] §f精靈樹的誕生",false)
...
ScriptedQuests.getInstance().conversationManager.pushNPCQuestion(252,question1)