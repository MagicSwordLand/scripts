...
val npcIcon = IconFonts.getNPC(230);
val npcName = "§b● §e以撒§r"
val side01 = "side_gold_04"
...
val question1 = NPCQuestion(*Utils.getMessage(npcIcon,
    ...
    .addPlayerOptions(
        ...
        PlayerOption("&7[&a對話選項&7] &f你還好嗎？ &8（輕輕搖醒）")
        ...
        // 任務
        PlayerOption("§7[§b金牌支線§7] §f聆聽瞌睡老人的夢話 &8(階級需求:黃金)")
...
ScriptedQuests.getInstance().questManager.getQuest(side01).ifPresent {
    question1.addPlayerOptions(it.getStartOption("§7[§b金牌支線§7] §f聆聽瞌睡老人的夢話",false)
...
ScriptedQuests.getInstance().conversationManager.pushNPCQuestion(230,question1)