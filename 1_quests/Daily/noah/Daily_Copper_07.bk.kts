...
val questID = "daily_copper_07"
fun command(line: String){
    Bukkit.dispatchCommand(Bukkit.getConsoleSender(),line);
}

class Daily_Copper_07: TimeLimitQuest(questID,"§7[§a銅牌每日§7] §f討伐哥布林王"){
    ...
    private val mes1 = arrayOf(
        *Utils.getMessage(npcIcon,
            ...
            "&x&d&6&d&0&b&8哥布林王每隔一段時間就會侵略諾亞村",
            "&x&d&6&d&0&b&8",
        ),
        *Utils.getMessage(npcIcon,
            "$dayNPC",
            "&x&d&6&d&0&b&8尊敬的傭兵你好一段時間就會去討伐哥布林王",
    ...
    init {
        ...
        val obj2 = KillMultiMobsObjective(this,"obj2", mapOf(
            "哥布林部落_哥布林王" to 1))
            .setInstruction{ "§7擊殺哥布林王 ${it.get("哥布林部落_哥布林王")}/1"}
