...
val questID = "daily_silver_03"

class Daily_Silver_03: TimeLimitQuest(questID,"§7[§a銀牌每日§7] §f屠鬼達人"){
    ...
    private val mes1 = arrayOf(
        *Utils.getMessage(npcIcon,
            "$dayNPC",
            "&x&d&6&d&0&b&8這位傭兵",
            "&x&d&6&d&0&b&8低語森林中的鬼魂開始密集誕生",
            "&x&d&6&d&0&b&8甚至開始向森林外延伸了",
        ),
        *Utils.getMessage(npcIcon,
            "$dayNPC",
            "&x&d&6&d&0&b&8希望你可以稍微緩減鬼魂數量",
        ),
    ...
    init {
        ...
        val obj2 = KillMobsObjective(this,"obj2","低語森林_",15)
            .setInstruction { "擊殺 ${it.amount} / 15 個低語森林中的鬼魂" };
