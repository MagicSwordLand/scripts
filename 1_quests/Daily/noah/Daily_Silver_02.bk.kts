...
val questID = "daily_silver_02"

class Daily_Silver_02: TimeLimitQuest(questID,"§7[§a銀牌每日§7] §f驅逐盜賊"){
    ...
    private val mes1 = arrayOf(
        *Utils.getMessage(npcIcon,
            "$dayNPC",
            "&x&d&6&d&0&b&8這位傭兵",
            "&x&d&6&d&0&b&8諾亞鎮旁的盜賊依然蠢蠢欲動",
            "&x&d&6&d&0&b&8每天都聚集著各地的盜賊",
        ),
        *Utils.getMessage(npcIcon,
            "$dayNPC",
            "&x&d&6&d&0&b&8希望你能給他們一點教訓",
            "&x&d&6&d&0&b&8擊敗幾個盜賊以免他們人數持續上升",
        ),
    ...
    init {
        ...
        val obj2 = KillMobsObjective(this,"obj2","盜賊據點_",20)
