...
val questID = "daily_copper_04"
fun command(line: String){
    Bukkit.dispatchCommand(Bukkit.getConsoleSender(),line);
}

class Daily_Copper_04: TimeLimitQuest(questID,"§7[§a銅牌每日§7] §f鍛造素材I"){
    ...
    init {
        ...
        val obj2 = GiveItemObjective(this,"obj2",16,"MATERIAL:M003",12)
            .setInstruction { "收集 ${it.amount} / 12 個 受汙染的骸骨 並交給莉亞莫" }
