...
val questID = "daily_saha_gold_08"

class Daily_SaHa_Gold_08: TimeLimitQuest(questID,"§7[§a金牌每日§7] §f迷惑離石像"){
    ...
    init {
        ...
        val obj2 = KillMobsObjective(this,"obj2","迷離山岩_迷惑離石像",1)
            .setInstruction { "擊殺 ${it.amount} / 1 迷惑離石像" };
        ...
        addRewards(
            ...
            QuestExpReward(35), //金牌20~40 白金60~100
