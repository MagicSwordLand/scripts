...
val questID = "daily_saha_platinum_02"

class Daily_SaHa_Platinum_02: TimeLimitQuest(questID,"§7[§a白金每日§7] §f雙隱之甲"){
    ...
    private val mes1 = arrayOf(
        *Utils.getMessage(playerIcon,
            "$playerName",
            "&x&d&6&c&1&a&e強大的盔甲需要雙隱之甲當作材料",
            "&x&d&6&c&1&a&e需要收集三個雙隱之甲...",
            "&x&d&6&c&1&a&e難不倒我的！",
        ),
    )
    ...
    init {
        ...
        val obj2 = GiveItemObjective(this,"obj2",171,"BOSSMATERIAL:M012",3)
            .setInstruction { "§7收集 ${it.amount} / 3 個 雙隱之甲 §7並交給§e威克斯" }
        ...
        addRewards(
            ...
            ClassExpReward(450), //金牌100~200 白金250~500
...
val quest = Daily_SaHa_Platinum_02();
