...
val questID = "daily_saha_gold_07"

class Daily_SaHa_Gold_07: TimeLimitQuest(questID,"§7[§a金牌每日§7] §f砂岩巨龜"){
    ...
    init {
        ...
        val obj2 = KillMobsObjective(this,"obj2","砂岩灘地_砂岩巨龜",1)
            .setInstruction { "擊殺 ${it.amount} / 1 砂岩巨龜" };
        ...
        addRewards(
            ...
            ClassExpReward(180), //金牌100~200 白金250~500
