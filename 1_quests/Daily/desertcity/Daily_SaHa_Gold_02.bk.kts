...
val questID = "daily_saha_gold_02"

class Daily_SaHa_Gold_02: TimeLimitQuest(questID,"§7[§a金牌每日§7] §f灘地砂粉"){
    ...
    init {
        ...
        val obj2 = GiveItemObjective(this,"obj2",171,"MATERIAL:M012",16)
            .setInstruction { "§7收集 ${it.amount} / 16 個 灘地砂粉 §7並交給§e威克斯" }
        ...
        addRewards(
            MoneyReward(70), //金牌60~120 白金150~200
