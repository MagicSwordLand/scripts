...
val questID = "daily_saha_gold_06"

class Daily_SaHa_Gold_06: TimeLimitQuest(questID,"§7[§a金牌每日§7] §f甘甜西瓜"){
    ...
    private val mes1 = arrayOf(
        *Utils.getMessage(playerIcon,
            "$playerName",
            "&x&d&6&c&1&a&e想要吃到最好吃的西瓜..",
            "&x&d&6&c&1&a&e害我也想吃吃看了",
        ),
    )
    ...
    init {
        ...
        val obj2 = GiveItemObjective(this,"obj2",171,"COLLECTMATERIAL:M025",32)
            .setInstruction { "§7收集 ${it.amount} / 32 個 甘甜西瓜 §7並交給§e威克斯" }
        ...
        addRewards(
            MoneyReward(60), //金牌60~120 白金150~200
            ClassExpReward(100), //金牌100~200 白金250~500
