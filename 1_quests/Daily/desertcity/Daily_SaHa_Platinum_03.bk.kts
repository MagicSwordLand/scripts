...
val questID = "daily_saha_platinum_03"

class Daily_SaHa_Platinum_03: TimeLimitQuest(questID,"§7[§a白金每日§7] §f喚魔之使"){
    ...
    private val mes1 = arrayOf(
        *Utils.getMessage(playerIcon,
            "$playerName",
            "&x&d&6&c&1&a&e紅砂山脈的喚魔之使過多...",
            "&x&d&6&c&1&a&e需要傭兵們前去清理",
            "&x&d&6&c&1&a&e他們可是很難對付的...",
        ),
    )
    ...
    init {
        ...
        val obj2 = KillMobsObjective(this,"obj2","紅砂山脈_喚魔之使 ",20)
            .setInstruction { "擊殺 ${it.amount} / 20 喚魔之使" };
        ...
        addRewards(
            ...
            ClassExpReward(400), //金牌100~200 白金250~500
...
val quest = Daily_SaHa_Platinum_03();
