...
val questID = "daily_saha_gold_01"

class Daily_SaHa_Gold_01: TimeLimitQuest(questID,"§7[§a金牌每日§7] §f穹頂內的亡靈"){
    ...
    private val mes1 = arrayOf(
        *Utils.getMessage(playerIcon,
            "$playerName",
            "&x&d&6&c&1&a&e穹頂沙淵中的亡魂肆虐...",
            "&x&d&6&c&1&a&e請傭兵們前往討伐...",
            "&x&d&6&c&1&a&e看起來挺適合我！",
        ),
    )
    ...
    init {
        ...
        val obj2 = KillMultiMobsObjective(this,"obj2", mapOf(
            "穹頂沙淵_沙淵亡魂" to 30,))
            .setInstruction{ "擊殺沙淵亡魂 ${it.get("穹頂沙淵_沙淵亡魂")}/30"}
