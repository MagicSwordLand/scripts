...
val questID = "daily_saha_gold_03"

class Daily_SaHa_Gold_03: TimeLimitQuest(questID,"§7[§a金牌每日§7] §f阿努比斯傳說"){
    ...
    private val mes1 = arrayOf(
        *Utils.getMessage(playerIcon,
            "$playerName",
            "&x&d&6&c&1&a&e前往阿努比斯神殿...",
            "&x&d&6&c&1&a&e將裡面的怪物清理一番",
            "&x&d&6&c&1&a&e有點難度呢！",
        ),
    )
    ...
    init {
        ...
        val obj2 = KillMobsObjective(this,"obj2","阿努比斯神殿_",30)
            .setInstruction { "擊殺 ${it.amount} / 30 阿努比斯怪物" };
