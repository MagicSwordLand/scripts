...
val questID = "daily_saha_platinum_04"

class Daily_SaHa_Platinum_04: TimeLimitQuest(questID,"§7[§a白金每日§7] §f綠洲部落"){
    ...
    private val mes1 = arrayOf(
        *Utils.getMessage(playerIcon,
            "$playerName",
            "&x&d&6&c&1&a&e對抗沙原綠洲中的部落",
            "&x&d&6&c&1&a&e這可是非常凶殘的部落..",
        ),
    )
    ...
    init {
        ...
        val obj2 = KillMobsObjective(this,"obj2","沙原綠洲_ ",50)
            .setInstruction { "擊殺 ${it.amount} / 50 沙原綠洲的怪物" };
...
val quest = Daily_SaHa_Platinum_04();
