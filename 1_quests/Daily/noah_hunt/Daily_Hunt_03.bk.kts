...
val questID = "daily_hunt_03"

class Daily_Hunt_03: TimeLimitQuest(questID,"§7[§a每日懸賞§7] §f白骨怪物"){
    ...
    init {
        ...
        val obj2 = KillMultiMobsObjective(this,"obj2", mapOf(
            "彼遺古岸_白骨兵" to 10,))
            .setInstruction{ "擊殺白骨兵 ${it.get("彼遺古岸_白骨兵")}/10"}
