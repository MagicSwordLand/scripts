...
val questID = "daily_hunt_02"

class Daily_Hunt_02: TimeLimitQuest(questID,"§7[§a每日懸賞§7] §f惡沼花"){
    ...
    private val mes1 = arrayOf(
        *Utils.getMessage(playerIcon,
            "$playerName",
            "&x&d&6&c&1&a&e採集惡沼花x16",
            "&x&d&6&c&1&a&e好像是毒氣林獨有的植物",
            "&x&d&6&c&1&a&e嘗試看看好了",
        ),
    )
    ...
    init {
        ...
        val obj2 = GiveItemObjective(this,"obj2",16,"COLLECTMATERIAL:M033",16)
            .setInstruction { "§7收集 ${it.amount} / 16 個 惡沼花§8(毒氣林)§7 並交給§e莉亞莫" }
