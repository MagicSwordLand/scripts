...
val questID = "daily_hunt_04"

class Daily_Hunt_04: TimeLimitQuest(questID,"§7[§a每日懸賞§7] §f將軍扇"){
    ...
    private val mes1 = arrayOf(
        *Utils.getMessage(playerIcon,
            "$playerName",
            "&x&d&6&c&1&a&e收集一個將軍的舞扇..",
            "&x&d&6&c&1&a&e好像是擊敗哥布林王掉落的素材",
            "&x&d&6&c&1&a&e嘗試看看好了",
        ),
    )
    ...
    init {
        ...
        val obj2 = GiveItemObjective(this,"obj2",16,"BOSSMATERIAL:M001",1)
            .setInstruction { "§7收集 ${it.amount} / 1 個 將軍的舞扇§8(哥布林部落)§7 並交給§e莉亞莫" }
