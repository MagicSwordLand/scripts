...
val questID = "main_ch8_01"

class MainCh8_01: Quest(questID,"§7[§c主線委託§7] §f第七章-異端發源"){
    ...
    init {
        ...
        val obj0 = ReachLevelObjective("obj0", 999)
            .setInstruction("§c該任務尚未開放，開放後將自動開始任務");
