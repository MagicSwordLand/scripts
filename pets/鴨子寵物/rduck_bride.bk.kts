...
class rduck_bride: HeroesPet("rduck_bride","rduck_bride"), UpgradeablePet {
    ...
    override fun getIcon(player: Player?, pet: Pet): ItemStack {
        ...
        itemMeta.setDisplayName("§f新娘鴨鴨 §7Lv.${pet.level}")
        val lore = buildList {
            add("")
...
HeroesPets.getPlugin().petManager.register(rduck_bride());