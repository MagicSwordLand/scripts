...
class rduck_miner: HeroesPet("rduck_miner","rduck_miner"), UpgradeablePet {
    ...
    override fun getIcon(player: Player?, pet: Pet): ItemStack {
        ...
        itemMeta.setDisplayName("§f礦工鴨鴨 §7Lv.${pet.level}")
        val lore = buildList {
            add("")
...
HeroesPets.getPlugin().petManager.register(rduck_miner());