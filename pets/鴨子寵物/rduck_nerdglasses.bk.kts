...
class rduck_nerdglasses: HeroesPet("rduck_nerdglasses","rduck_nerdglasses"), UpgradeablePet {
    ...
    override fun getIcon(player: Player?, pet: Pet): ItemStack {
        ...
        itemMeta.setDisplayName("§f書呆子鴨鴨 §7Lv.${pet.level}")
        val lore = buildList {
            add("")
...
HeroesPets.getPlugin().petManager.register(rduck_nerdglasses());