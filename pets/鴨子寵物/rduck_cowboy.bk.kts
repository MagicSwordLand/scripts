...
class rduck_cowboy: HeroesPet("rduck_cowboy","rduck_cowboy"), UpgradeablePet {
    ...
    override fun getIcon(player: Player?, pet: Pet): ItemStack {
        ...
        itemMeta.setDisplayName("§f牛仔鴨鴨 §7Lv.${pet.level}")
        val lore = buildList {
            add("")
...
HeroesPets.getPlugin().petManager.register(rduck_cowboy());