...
class rduck_top_hat: HeroesPet("rduck_top_hat","rduck_top_hat"), UpgradeablePet {
    ...
    override fun getIcon(player: Player?, pet: Pet): ItemStack {
        ...
        itemMeta.setDisplayName("§f禮帽鴨鴨 §7Lv.${pet.level}")
        val lore = buildList {
            add("")
...
HeroesPets.getPlugin().petManager.register(rduck_top_hat());